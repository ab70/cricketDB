...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="<?php echo $path ?>/views/" >CricketDb -Admin</a>
    ...
    <ul class="navbar-nav ml-auto ">
      <li class="nav-item dropdown usernav">
        ...
        <a class="nav-link dropdown-toggle" class="nav-link dropdown-toggle"  id="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href=""><img src="<?php echo $path ?>assets/img/user.png" >
          ...
          <a class="dropdown-item" href="<?php echo $path ?>views/admin/logout.php">Log out</a>
        </div>
          <?php } 
          else{
            echo "Login";
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3" id="admin-menu">
                         <ul class="menu-list">
                            ...
                            <li ><a href="liveupdate.php">Live update</a></li>
                            <li ><a href="coach.php">Add coach</a></li>
                            
                            <li ><a href="squadlist.php">Squad List & officials</a></li>
